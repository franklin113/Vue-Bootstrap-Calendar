...
import { CHANGE_MONTH, WEEK_SELECTED } from "./actions";
...
export default {
  ...
  components: {
    CalendarHeader: require("./Components/Header.vue").default
      ? require("./Components/Header.vue").default
      : require("./Components/Header.vue"),
    Week: require("./Components/Week.vue").default
      ? require("./Components/Week.vue").default
      : require("./Components/Week.vue"),
  },
  created() {
    let me = this;
